...
$(document).ready(function() {
  ...
  .done(function(msg){
    ...
    .done(function(msg){
      if(msg.length==0){
        $("#campoderesultado").html("<div id=\"aviso\" class=\"alert alert-warning\"><strong>Nada!</strong> Você ainda não tem nenhum prontuário cadastrado.</div>");
      }
      else{
